...
var All = []CLISpec{
	...
	{
		ModelID:        "cli-claude-sonnet-1m",
		ModelName:      "Claude Sonnet 1M (CLI)",
		ContextWindow:  1_000_000,
		Binary:         "claude",
		PromptFlag:     "-p",
		BuildArgs:      claudeArgs("sonnet[1m]"),
		NewPartParser:  claudePartParser,
		ParseUsageLine: claudeParseUsageLine,
		UseCrushMCP:    true,
	},
	{
		ModelID:        "cli-claude-opus-1m",
		ModelName:      "Claude Opus 1M (CLI)",
		ContextWindow:  1_000_000,
		Binary:         "claude",
		PromptFlag:     "-p",
		BuildArgs:      claudeArgs("opus[1m]"),
		NewPartParser:  claudePartParser,
		ParseUsageLine: claudeParseUsageLine,
		UseCrushMCP:    true,
	},
